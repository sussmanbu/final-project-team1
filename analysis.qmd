...
ols<-lm(log(total_cases)~ pct_white+pct_black+asian_pct+nhpt_pct+aian_pct+district_name*pct_black, data = lm_dat)
...
coeftest(selected_model, vcov.=vcovHC)

stargazer(full_model, title="Log Regression Results", align=TRUE) #html standard output table 
...
coeftest(non_linear, vcov.=vcovHC)

stargazer(non_linear, title="Non-Linear Regression Results", align=TRUE)
