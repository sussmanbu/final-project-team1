...
draft: FALSE
description: In this blog post, we detail the process of cleaning the Boston shooting dataset, including simplifying column names, categorizing values, handling duplicates, and integrating demographic information, while also discussing principles of equity in data analysis such as beneficence and transparency.
---
