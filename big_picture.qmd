...
In the heart of Boston, an unsettling pattern emerges—gun violence casts a long shadow across its diverse neighborhoods. But what factors contribute to this grave issue? Our comprehensive analysis on shooting data over the past decade seeks to uncover whether socioeconomic status could be the central factor in understanding and perhaps mitigating this violence.
