...
final_df%>%
  ...
  labs(y = 'Avg Median Income', x = 'District Name', title = 'Average Median Income and Total Cases Over All Years', fill= 'Total Cases')+
  annotate("text", x = Inf, y = Inf, label = paste("Correlation coefficient: ", correlation_coef), hjust = 2.5, vjust = 1)+ #chat GPT add correlation coefficient to barplot
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
final_df%>%
  ...
  geom_bar(stat= 'identity')+
  theme(axis.text.x = element_text(angle = 90, vjust = 2.5, hjust=1))+
  labs(y = 'Percent Unemployed', x='District Name', title = 'Average Unemployment and Total Cases', fill= 'Total Cases')+
  annotate("text", x = Inf, y = Inf, label = paste("Correlation coefficient: ", correlation_coef), hjust = 2.5, vjust = 1)+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
final_df%>%
  ...
  geom_bar(stat= 'identity')+
  labs(y = 'Percent with Bachelors Degree', x = 'District Name', title = 'Bachelors Degree and Total Cases', fill = 'Total Cases')+
  annotate("text", x = Inf, y = Inf, label = paste("Correlation coefficient: ", correlation_coef), hjust = 2.5, vjust = 1)+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
